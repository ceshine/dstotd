...
The most interesting news today is Google introducing a algorithm which automatically find optimal image augmentation policies, and a paper investigating the possible overfitting in published CIFAR-10 models.
